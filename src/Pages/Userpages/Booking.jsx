...
function Booking() {
  ...
  return (
    ...
    <>
      <h3 className='text-xl mb-4 text-gray-700  font-bold p-1 text-center'>Booking <span className="text-gray-700 font-bold">Details</span></h3>
      <div className='flex justify-center items-center h-screen'>
        <div className='flex flex-col lg:flex-row w-[70%] rounded-2xl shadow-xl shadow-gray-800'>
          <div className='flex flex-col  w-full lg:w-full p-8'>
            <div className='mb-4'>
              <p className='text-gray-900 font-medium mb-2'>Username: fasalu</p>
              <p className='text-gray-900 font-medium'>Email: fasalgafoor2080@gmail.com</p>
            </div>
          ...
          <div className='w-full lg:w-auto p-8 mt-8'>
            <div className='ml6 mt-10 mb-12'>
              <div className='flex flex-row justify-between'>
                <h1 className='text-3xl font-semibold mb-2 text-gray-900 '>Package   Details</h1>
              </div>
              <ul className='list-disc pl-3 space-y-4'>
                <li className='mb-2 text-gray-900 font-mono'>Destrict: <span className='text-black font-semibold'>{packagee.Destrictname}</span></li>
